...
const Test = () => {
    return (
        <div className="bg-slate-900">
            <div className="max-w-4xl mx-auto px-4 py-8 bg-slate-700">
                <h1 className="text-3xl font-semibold text-center text-gray-300 mb-4">Welcome to the Test Page!</h1>
                ...
                <h2 className="text-2xl font-semibold text-gray-300 mb-4">Example Data Table</h2>
                <p className="text-lg text-gray-400 mb-6">
